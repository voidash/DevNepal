...
const lines = [
  ...
  ['04-visitor-issue-profile.mp3', 'Visitors see the repository’s live open issues inside DevNepal. Issue seven includes its complete goal and acceptance criteria, then links to the original GitHub issue. Contributor profiles show only cached public GitHub information.'],
